...
--
-- Hôte : localhost:8889
-- Généré le : mar. 01 sep. 2026 à 18:03
...
(11, 5, 'PSM-20260901-7364F6', '2026-09-01 17:37:15', 'EN_LIGNE', 'EN_ATTENTE', 'LIVRAISON', 3, 103, 'Maison AKPAKA Ambroise', 2800.00, 1500.00, 4300.00, NULL, 0, NULL, '2026-09-01 17:37:15', '2026-09-01 17:37:15');
...
(1, 1, 'MTN', 'MTN est un poisson tres prisé et tres gouteux', 1700.00, 'KG', 17.000, 5.000, 'assets/uploads/produits/96a00cfff046296197648ac4c8a5e098.webp', 1, '2026-08-31 18:11:55', '2026-09-01 15:46:20'),
(2, 1, 'SALOMON', 'Poisson tres prisé par les revendeuses pour differents mets locaux', 1500.00, 'KG', 7.000, 5.000, 'assets/uploads/produits/dbc37ecf8e01972d1301ed1577df8117.jpg', 1, '2026-08-31 18:13:29', '2026-09-01 16:43:16'),
(3, 2, 'AILERON', 'Viande tres prisée pour les grillades', 2800.00, 'KG', 18.000, 3.000, 'assets/uploads/produits/af55951ce739066e929ee1523ce123a8.jpg', 1, '2026-08-31 18:14:13', '2026-09-01 17:37:15'),
(4, 3, 'OEUFS DE POULE', 'Oeufs de poule locaux', 100.00, 'UNITE', 46.000, 10.000, 'assets/uploads/produits/3600d815154a1752fdcc472fb02484a7.jpg', 1, '2026-08-31 18:14:50', '2026-08-31 19:17:09');
...
(1, 1, 'AKAKPOSSE Michael', 'akmdejesus@icloud.com', '0197927434', '$2y$10$70PsMiKrj72eYFeg.FISXeHcbC84VWaJW4JNVydxwYnJEGcg2DpPa', 1, '2026-09-01 16:44:52', '2026-08-31 17:58:12', '2026-09-01 16:44:52'),
...
(3, 3, 'AZIZ Mohamed', 'livreur@gmail.com', '0103040708', '$2y$10$Exdh/HQs7f6TWT2uyowqjedVwiMmfEtQW95o2zPRHfYZWftVXkTmG', 1, '2026-08-31 19:11:17', '2026-08-31 19:10:21', '2026-08-31 19:11:17');
...
--
ALTER TABLE `clients`
  MODIFY `id_client` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `historique_statuts_commande`
  MODIFY `id_historique_statut` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT pour la table `journal_audit`
--
ALTER TABLE `journal_audit`
  MODIFY `id_evenement` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;

--
-- AUTO_INCREMENT pour la table `justificatifs_paiement`
--
ALTER TABLE `justificatifs_paiement`
  MODIFY `id_justificatif` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `notifications`
  MODIFY `id_notification` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
ALTER TABLE `quartiers_livraison`
  MODIFY `id_quartier_livraison` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=271;
