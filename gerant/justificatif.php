...
<head>
  ...
  <style nonce="<?= e(cspNonce()) ?>">
    ...
    .brand { color: #064534; font: 700 26px Georgia, serif; }.tag { height: max-content; padding: 7px 10px; font-weight: 700; background: #f5be30; border-radius: 999px; }
...
<body>
  <main class="receipt">
    <div class="top"><div><div class="brand">Poissonnerie Saint-Michel</div><p>Akpakpa · Cotonou</p></div><span class="tag">REÇU DE PAIEMENT</span></div>
